package com.learn2code.vehicle.api.search.controler;
...
import com.learn2code.vehicle.api.search.service.impl.ManufacturerServiceImpl;
...
public class ManufacturerController {
    ...
    public ResponseEntity<Manufacturer> createManufacturerInDB(@RequestBody Manufacturer manufacturer){
        Manufacturer dbRecord= manufacturerService.saveManufaturer(manufacturer);
